...
--showing total death, total case by continent ***** 
...
sum(cast(VA.new_vaccinations as int)) over (partition by DE.location order by DE.location) as RollingpeopleVaccinated
